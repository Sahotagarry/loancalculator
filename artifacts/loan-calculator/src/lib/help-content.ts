...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The app suggests a market rate based on the Bank of Canada prime rate at the loan's start date (prime + 2%). The fair value rate is editable in the ASPE 3856 warning panel on the loan page — enter your own market rate (for example, an actual rate quote or one reflecting the borrower's credit profile) before or after recording the decision, and the fair value schedule, adjusting entries, and disclosures update automatically. A 'Reset to suggested' action restores the prime + 2% rate.",
